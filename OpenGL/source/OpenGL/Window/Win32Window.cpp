...
Window::Window(int resolutionX, int resolutionY)
{
	...
	RECT windowContent = {0, 0, resolutionX, resolutionY};
	AdjustWindowRect(&windowContent, WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU, false);

	m_handle = CreateWindowEx(NULL, MAKEINTATOM(classId), L"GPGPU and MGTR Game Engine", WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU, CW_USEDEFAULT, CW_USEDEFAULT,
								windowContent.right - windowContent.left, windowContent.bottom - windowContent.top, NULL, NULL, NULL, NULL);
